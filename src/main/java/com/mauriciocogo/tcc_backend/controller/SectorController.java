...
public class SectorController {
    ...
    @Operation(
        ...
        description = "Cria um novo setor com as informações fornecidas, incluindo o vínculo com um usuário responsável (via CPF)."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Retorna uma lista de todos os setores cadastrados no sistema."
    )
    ...
    @Operation(
        ...
        description = "Retorna os dados de um setor específico com base no ID fornecido."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Atualiza as informações de um setor existente com base no ID fornecido."
    )
    @ApiResponses({
